      ...
      <div className="container mx-auto px-5 relative">
        <div className="text-center mb-12 md:mb-16">
          ...
          <motion.h2
            ...
            className="mt-4 text-[28px] sm:text-[38px] md:text-[46px] font-cormorant font-semibold text-gray-900"
          >
          ...
          <motion.p
            ...
            className="mt-6 max-w-[720px] mx-auto text-[15px] sm:text-[16px] text-[#555] font-muli leading-loose"
          >
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-center mb-20 md:mb-28">
          ...
          >
            ...
            <h3 className="mt-6 text-[24px] font-cormorant font-semibold text-gray-900">
              Modern Designs, Timeless Appeal
            </h3>
            <p className="mt-3 text-[15px] text-[#555] font-muli leading-relaxed max-w-[420px] mx-auto md:mx-0">
            ...
            <ul className="mt-8 space-y-4 text-left max-w-[420px] mx-auto md:mx-0">
              {features.map((f, i) => (
                <motion.li
                  key={f.title}
                ...
                >
                  <span className="w-9 h-9 shrink-0 rounded-full bg-[var(--color-2)]/10 text-[var(--color-2)] flex items-center justify-center text-[14px]">
                    <i className={f.icon} />
                  </span>
                  <span>
        ...
        >
          <div className="text-center mb-10 md:mb-14">
            ...
            <h3 className="mt-4 text-[26px] md:text-[30px] font-cormorant font-semibold text-gray-900">
              Explore Our Featured Properties
            </h3>
            <p className="mt-3 text-[15px] text-[#555] font-muli leading-relaxed max-w-[600px] mx-auto text-center">
          ...
          <div className="relative overflow-hidden rounded-2xl shadow-[0_25px_70px_rgba(0,0,0,0.18)]">
            ...
            <div className="absolute bottom-12 left-5 right-5 md:bottom-16 md:left-10 md:right-10 flex items-end justify-between gap-4">
              <div>
                <div className="text-[11px] font-muli font-bold tracking-[0.25em] text-[#ff8080] uppercase mb-1">
                  Featured Property
                </div>
