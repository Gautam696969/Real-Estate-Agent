  ...
  return (
    <section style={{ padding: '80px 0', backgroundColor: '#f5f5f5' }} className="section-padding">
      <div className="container">
        ...
        <div style={{ width: 60, height: 2, backgroundColor: 'var(--color_2)', marginBottom: 48, marginLeft: 'auto', marginRight: 'auto' }} />
        ...
        <div style={{ display: 'flex', gap: 40, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: 300, padding: '0 20px' }}>
            <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 28, marginBottom: 16 }}>
              {testimonials[currentSlide].name}
            </h3>
            <p style={{ fontSize: 16, lineHeight: 1.8, color: '#2d2e32', fontStyle: 'italic' }}>
